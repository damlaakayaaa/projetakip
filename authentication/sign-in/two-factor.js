    ...
    return {
        init: function () {
            ...
            t = document.querySelector("#kt_sing_in_two_factor_form"), (e = document.querySelector("#kt_sing_in_two_factor_submit")).addEventListener("click", (function (n) {
                n.preventDefault();
                var i = !0;
                var o = [].slice.call(t.querySelectorAll('input[maxlength="1"]'));
                o.map((function (t) {
            ...
            })), n = t.querySelector("[name=code_1]"), i = t.querySelector("[name=code_2]"),
                o = t.querySelector("[name=code_3]"), u = t.querySelector("[name=code_4]"), r = t.querySelector("[name=code_5]"),
                c = t.querySelector("[name=code_6]"), n.focus(), n.addEventListener("keyup", (function () {
